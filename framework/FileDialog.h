...
public:
	...
	static constexpr float EXPLORER_PROPORTION_HEIGHT = 0.75f;
	static constexpr float EXPLORER_PROPORTION_WIDTH = 0.75f;
	...
	static constexpr int EXPLORER_TOP = (WINDOW_HEIGHT - EXPLORER_HEIGHT) / 2;
	static constexpr int EXPLORER_LEFT = (WINDOW_WIDTH - EXPLORER_WIDTH) / 2;
